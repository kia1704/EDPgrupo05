...
class Planificador:
    ...
    def evaluar_rutas(origen, destino, peso_carga):
        ...
        for ruta in rutas:
            ...
            resultados.append({'ruta': ruta, 'costo': costo_ruta + costo_tras, 'tiempo': tiempo_ruta, 'distancia vs tiempo': graf_t, 'distancia vs costo': graf_c})
        if resultados:
        ...
        return {'Mejor costo': mejor_por_costo, 'Mejor tiempo': mejor_por_tiempo}
